...
$sources= array (
    ...
    'source_core' => $root.'core/components/ditsnews',
    'lexicon' => $root . 'core/components/ditsnews/lexicon/',
...
$builder->createPackage('ditsnews','0.2.0','alpha2');
...
$category->set('id',1);
$category->set('category','DitsNews');
